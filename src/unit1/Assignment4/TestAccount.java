...
public class TestAccount {
	...
	public static void main(String[] args) {
		...
		System.out.printf("__________________________________%n%nWelcome to your JAVA Bank Account%n"
							...
							+ "New Balance: $%.2f%n__________________________________", user.dateCreated(), user.getId(), user.getMonthlyInterest(), withdraw, deposit, user.getBalance());	
